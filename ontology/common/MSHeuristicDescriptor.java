...
public class MSHeuristicDescriptor extends QualitativeHeuristicDescriptor {
   ...
   public void externalise(AbsObject absObj, Ontology onto) throws OntologyException {
    try {
      ...
      abs.set(CommonTerminologyOntology.MSHEURISTICDESCRIPTOR_VALUE, (AbsTerm) onto.fromObject(getValue()));
  ...
  public void internalise(AbsObject absObj, Ontology onto) throws UngroundedException, OntologyException {
    try {
      AbsConcept abs = (AbsConcept) absObj;
      value = (List)onto.toObject(abs.getAbsObject(CommonTerminologyOntology.MSHEURISTICDESCRIPTOR_VALUE));
